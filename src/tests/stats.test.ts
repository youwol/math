...
import {
    ...
    q25,
    q75,
} from '../lib/dataframe/stats/quantile'
...
test('stats cov', () => {
    ...
    x = Serie.create({
        array: [0.90010907, 0.13484424, 0.62036035],
        itemSize: 1,
    })
    y = Serie.create({
        array: [0.12528585, 0.26962463, 0.51111198],
        itemSize: 1,
    })
    c = covariance(x, y)
...
test('stats quantile', () => {
    const s = Serie.create({
        array: [
            57, 57, 57, 58, 63, 66, 66, 67, 67, 68, 69, 70, 70, 70, 70, 72, 73,
...
test('stats outliers', () => {
    const s = Serie.create({
        array: [
            57, 57, 57, 57, 58, 58, 59, 63, 66, 66, 67, 67, 68, 69, 70, 70, 70,
    ...
    expect(outliers(s, 0).array).toEqual([
        57, 57, 57, 57, 58, 58, 59, 75, 75, 76, 76, 78, 79, 81,
    ])
    expect(notOutliers(s, 0).array).toEqual([
        63, 66, 66, 67, 67, 68, 69, 70, 70, 70, 70, 72, 73,
    ])
